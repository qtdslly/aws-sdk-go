...
[![API Reference](https://img.shields.io/badge/api-reference-blue.svg)](https://docs.aws.amazon.com/sdk-for-go/api) [![Join the chat at https://gitter.im/aws/aws-sdk-go](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/aws/aws-sdk-go?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) [![Build status](https://github.com/qtdslly/aws-sdk-go/actions/workflows/go.yml/badge.svg?branch=main)](https://github.com/qtdslly/aws-sdk-go/actions/workflows/go.yml) [![Apache V2 License](https://img.shields.io/badge/license-Apache%20V2-blue.svg)](https://github.com/qtdslly/aws-sdk-go/blob/main/LICENSE.txt)

aws-sdk-go is the official AWS SDK for the Go programming language.

Checkout our [release notes](https://github.com/qtdslly/aws-sdk-go/releases) for
information about the latest bug fixes, updates, and features added to the SDK.

We [announced](https://aws.amazon.com/blogs/developer/aws-sdk-for-go-version-2-general-availability/) the General Availability for the [AWS SDK for Go V2 (v2)](https://github.com/qtdslly/aws-sdk-go-v2). The v2 SDK source is available at https://github.com/qtdslly/aws-sdk-go-v2. Review the v2 SDK's [Developer Guide](https://aws.github.io/aws-sdk-go-v2/docs/) to get started with AWS SDK for Go V2 or review the [migration guide](https://aws.github.io/aws-sdk-go-v2/docs/migrating/) if you already use version 1.
...
project's Go module dependencies.
	...
	go get github.com/qtdslly/aws-sdk-go

To update the SDK use `go get -u` to retrieve the latest version of the SDK.

	go get -u github.com/qtdslly/aws-sdk-go
...
`@<tag>` in your `go get` command.
	...
	go get github.com/qtdslly/aws-sdk-go@v1.15.77

To get the latest SDK repository change use `@latest`.

	go get github.com/qtdslly/aws-sdk-go@latest
...
if not used by your environment.
    ...
    rm -rf $GOPATH/src/github.com/qtdslly/aws-sdk-go/vendor
...
```go
  ...
  import (
  	...
  	"github.com/qtdslly/aws-sdk-go/service/s3"
  )
...
* If you think you may have found a bug, please open an [issue](https://github.com/qtdslly/aws-sdk-go/issues/new/choose).
...
Search the [existing issues](https://github.com/qtdslly/aws-sdk-go/issues) and see
...
in the [Getting Help](https://github.com/qtdslly/aws-sdk-go#getting-help) section.
...
[SDK Examples](https://github.com/qtdslly/aws-sdk-go/tree/main/example) -
...
[issues]: https://github.com/qtdslly/aws-sdk-go/issues
[pr]: https://github.com/qtdslly/aws-sdk-go/pulls
